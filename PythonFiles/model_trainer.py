...
Usage:
This program can be used for training a model with protein distance maps as data set. It reads labels and matrix data
from the csv data files and creates label and data batches for the training, validation and testing. It trains the model
using the train and validation data and tests the model using the test data. At last, the model and model weights will
be written to disk as JSON and HDF5 file respectively.
